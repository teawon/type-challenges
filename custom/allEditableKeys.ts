...
type AllEditableKeys<T> = keyof {
  [P in keyof T as Equal<Readonly<Pick<T, P>>, Pick<T, P>> extends true
    ? never
    : P]: any;
};
...
type cases = [
  ...
  Expect<
    Equal<AllEditableKeys<{ test1: number; readonly test2: string }>, "test1">
  >,
  Expect<
    Equal<
      AllEditableKeys<{
        test1: object;
        readonly test2?: undefined;
        test3: null;
        test4: string;
      }>,
      "test1" | "test3" | "test4"

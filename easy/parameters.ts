...
// 1. 일단 타입을 명시하기
// type MyParameters2 <T extends (...args: any[]) => any> = T extends (...args: any[]  ) => any

// 2. 추론해야 할 타입에 대해 infer 붙이기
//  type MyParameters2 <T extends (...args: any[]) => any> = T extends (...args: infer U) => any

// 3. 추론 타입 (U)에 대한 조건 분기
